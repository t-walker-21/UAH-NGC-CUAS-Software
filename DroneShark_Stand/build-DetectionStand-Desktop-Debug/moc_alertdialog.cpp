...
#include "../DetectionStand/alertdialog.h"
...
struct qt_meta_stringdata_AlertDialog_t {
    QByteArrayData data[3];
    char stringdata[27];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AlertDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AlertDialog_t qt_meta_stringdata_AlertDialog = {
    {
QT_MOC_LITERAL(0, 0, 11),
QT_MOC_LITERAL(1, 12, 13),
QT_MOC_LITERAL(2, 26, 0)
    },
    "AlertDialog\0updateOpacity\0"
};
...
const QMetaObject AlertDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_AlertDialog.data,
      qt_meta_data_AlertDialog,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AlertDialog.stringdata))
